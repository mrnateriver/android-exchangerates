...
public enum MainListEntryType {
    UNDEFINED,
    CONVERSION,
    MESSAGE;

    //the following is needed to access values by ordinal directly
    public static final MainListEntryType values[] = values();

    public static boolean withinRange(int ordinal) {
